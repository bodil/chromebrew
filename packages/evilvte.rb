...
class Evilvte < Package
  ...
  def self.build
    ...
    system "echo '#define HOTKEY_COPY CTRL_SHIFT(GDK_C) || CTRL_SHIFT(GDK_c)' >> src/config.h"
    system "echo '#define HOTKEY_PASTE CTRL_SHIFT(GDK_V) || CTRL_SHIFT(GDK_v)' >> src/config.h"
    ...
    system "echo '#define HOTKEY_SCROLL_ONE_PAGE_UP    SHIFT(GDK_Up)' >> src/config.h"
    system "echo '#define HOTKEY_SCROLL_ONE_PAGE_DOWN  SHIFT(GDK_Down)' >> src/config.h"
    ...
    system "echo '#define HOTKEY_TAB_PREVIOUS CTRL_SHIFT(GDK_Left)' >> src/config.h"
    system "echo '#define HOTKEY_TAB_NEXT CTRL_SHIFT(GDK_Right)' >> src/config.h"
